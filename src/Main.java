...
public class Main {
    public static void main(String[] args) {
        CombatOptions options = new CombatOptions(AllocationStrategy.WORST_SAVE_FIRST, AllocationStrategy.WORST_SAVE_FIRST, 6, false, true);
        ...
        helverinWeapons.add(new Weapon("Armoured feet", 4, 3, 6,0,new Damage(0,0,1), 0, Weapon.WeaponType.MELEE));
        ...
        spaceMarineWeapons.add(new Weapon("Close combat weapon", 3,3,4,0,new Damage(0,0,1),0, Weapon.WeaponType.MELEE));
