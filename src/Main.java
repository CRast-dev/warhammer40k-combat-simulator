...
public class Main {
    public static void main(String[] args) {
        ...
        helverinWeapons.add(new Weapon("Armiger Autocannon", 4, 3, 9,-1,3, 48));
        ...
        spaceMarineWeapons.add( new Weapon("Bolt rifle",2,3,4,-1,1, 24));
        spaceMarineWeapons.add(new Weapon("Bolt pistol", 1,3,4,0,1,12));
